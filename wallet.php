...
<div class="app-shell">
  ...
  <div class="page-content">
    ...
    <div style="background:var(--blanc);border-radius:6px;padding:32px;text-align:center;margin-bottom:12px;border:2px solid var(--noir);box-shadow:4px 4px 0 var(--noir);">
      ...
      <a href="/TitreRNCP/explore.php" class="btn btn-primary">→ Explorer les événements</a>
    </div>
    <?php endif; ?>
...
<nav class="bottom-nav">
  ...
  <a href="/TitreRNCP/wallet.php" class="nav-item active">
  ...
  <a href="/TitreRNCP/profil.php" class="nav-item">
